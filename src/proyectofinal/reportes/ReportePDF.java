...
public class ReportePDF {
    ...
    public void prueba() {
        ...
        String archivo = "EjercicioResuelto" + timestamp + ".pdf";
        String ruta = "C:\\Users\\sebas\\Downloads\\" + archivo;
        ...
        try {
            ...
            g.setColor(Color.RED);
            g.drawString("Rechel y Didi", 40, 150);
            
            
            g.setColor(Color.WHITE);
            g.drawString("UWU", 290, 150);
        ...
        JOptionPane.showMessageDialog(null, 
                "Se creo el archivo "+ archivo + " en la carpeta del proyecto");
    }
